...
function s:FindCommentify() " {{{
	...
	if fileType == 'ox' || fileType == 'cpp' || fileType == 'php' || fileType == 'java' || fileType == 'cs' || fileType == 'ftf' || fileType == 'torquescript' || fileType == 'pov' || fileType == 'javascript' || fileType == 'actionscript'
		let commentSymbol_L = '//'
		let commentSymbol_R = ''
	...
	elseif fileType == 'python' || fileType == 'perl' || fileType == 'make' || fileType =~ '[^w]sh$' || fileType == 'tcl' || fileType == 'jproperties' || fileType == 'ruby' || fileType == 'sh' || fileType == 'conf' || fileType == 'xf86conf' || fileType == 'muttrc' || fileType == 'yaml'
		let commentSymbol_L = '#'
		let commentSymbol_R = ''
